...
#define MINOR_VERSION           "20" /* Normal new features and changes       */
#define PATCH_VERSION           "2" /* Bugfixes, crashfixes etc.             */
#define VERSION_EXT             ""  /* "" OR "ALPHA", "BETA, "RC1", "RC2"... */

#define MUSH_RELEASE_DATE       "2025-07-01"          /* Source release date */
