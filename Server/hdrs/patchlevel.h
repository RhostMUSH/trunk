...
#define MINOR_VERSION           "11" /* Normal new features and changes       */
#define PATCH_VERSION           "1" /* Bugfixes, crashfixes etc.             */
#define VERSION_EXT             ""  /* "" OR "ALPHA", "BETA, "RC1", "RC2"... */

#define MUSH_RELEASE_DATE       "2024-11-18"          /* Source release date */
