...
#define MINOR_VERSION           "1" /* Normal new features and changes       */
#define PATCH_VERSION           "10" /* Bugfixes, crashfixes etc.             */
#define VERSION_EXT             ""  /* "" OR "ALPHA", "BETA, "RC1", "RC2"... */

#define MUSH_RELEASE_DATE       "2026-06-03"          /* Source release date */
