...
extern void     init_totemtab(void);
extern void     init_toggletab(void);
extern void	init_powertab(void);
extern void     display_flagtab(dbref);
extern void     display_toggletab(dbref);
extern void     display_totemtab(dbref, char *);
extern int	totem_cansee(dbref, dbref, char *);
extern int	totem_cansee_bit(dbref, dbref, int);
extern int	totem_flags(char *, dbref, dbref, char *);

extern void     display_flagtab2(dbref, char *, char **);
extern void     display_toggletab2(dbref, char *, char **);
extern void     display_totemtab2(dbref, char *, char **, int, char *);
extern void     flag_set(dbref, dbref, char *, int);
extern void     toggle_set(dbref, dbref, char *, int);
extern void     power_set(dbref, dbref, char *, int);
extern char *   flag_description(dbref, dbref, int, int *, int);
extern char *   toggle_description(dbref, dbref, int, int, int *);
extern char *   power_description(dbref, dbref, int, int);
extern char *   depower_description(dbref, dbref, int, int);
extern FLAGENT *find_flag(dbref, char *);
extern TOGENT *find_toggle(dbref, char *);
extern TOTEMENT *find_totem(dbref, char *);
extern int	check_totem(dbref, dbref, char *);
extern char *   decode_flags(dbref, dbref, FLAG, FLAG, FLAG, FLAG);
extern void     decode_flags_func(dbref, dbref, FLAG, FLAG, FLAG, FLAG, char *, char *);
extern int      has_flag(dbref, dbref, char *);
extern char *   unparse_object(dbref, dbref, int);
extern char *   unparse_object_altname(dbref, dbref, int);
extern char *   unparse_object_ansi(dbref, dbref, int, int);
extern char *   unparse_object_ansi_altname(dbref, dbref, int);
extern char *   unparse_object2(dbref, dbref, int);
extern char *   unparse_object_numonly(dbref);
extern char *   ansi_exitname(dbref);
extern int      convert_flags(dbref, char *, FLAGSET *, FLAG *, int);
extern void     decompile_flags(dbref, dbref, char *, char *, int);
extern void     decompile_toggles(dbref, dbref, char *, char *, int);
extern void     decompile_totems(dbref, dbref, char *, char *, int);
extern int	HasPriv(dbref, dbref, int, int, int);

extern int	parse_aflags(dbref, dbref, int, char *, char **, int);
extern char *	give_name_aflags(dbref, dbref, int);
extern int	has_aflag(dbref, dbref, int, char *);
