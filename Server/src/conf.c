...
CONF conftable[] =
{
    ...
    {(char *) "mysql_user",
     cf_string, CA_DISABLED, (int *) mudconf.mysql_user, 126, 0, CA_WIZARD,
     (char *) "MySQL user of database to connect to."},
    {(char *) "mysql_pass",
     cf_string, CA_DISABLED, (int *) mudconf.mysql_pass, 126, 0, CA_WIZARD,
     (char *) "MySQL password of user of database to connect to."},
    {(char *) "mysql_base",
     cf_string, CA_DISABLED, (int *) mudconf.mysql_base, 126, 0, CA_WIZARD,
     (char *) "MySQL database name to connect to."},
    {(char *) "mysql_socket",
     cf_string, CA_DISABLED, (int *) mudconf.mysql_socket, 126, 0, CA_WIZARD,
