#ifndef _M_COPYRIGHT_
#define _M_COPYRIGHT_
 ...
 * all rights reserved.
 *
 * Rhostcode defined as all changes/modifications/alterations and rewrites
 * contained in this source by code or by text from the original TinyMUD code.
 *
