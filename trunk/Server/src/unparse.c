...
static void unparse_boolexp1(dbref player, BOOLEXP *b, 
		char outer_type, int format)
{
ATTR	*ap;
char	*tbuf, sep_ch;
#ifndef STANDALONE
char	*buff;
	...
	case BOOLEXP_CONST:
		...
		case F_DECOMPILE:
			...
			/* Decompile output - should be usable on other MUSHes.
			 * *Name if player, Name if thing, else #Num
			 */
